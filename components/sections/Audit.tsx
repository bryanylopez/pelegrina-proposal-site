...
export function Audit() {
  ...
  const s = sections[locale].audit;

  return (
    <section id="audit" className="bg-brand-mist py-24 sm:py-32">
          ...
          {s.findings.map((f, i) => (
            <Reveal key={f.title} delay={i * 100}>
              <div className="h-full rounded-3xl bg-white p-8 shadow-sm">
                <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-full bg-brand-mist">
